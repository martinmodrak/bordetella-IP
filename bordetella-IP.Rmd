...
adjusted_all <- results_msqrob %>% filter(model == "Adjusted") %>% pull("protein") %>% unique()

save_width <- 10
save_height <- 8

adjusted_1 <- plot_peptides(LFQ, adjusted_all[1:25], scales = "free_y") + ggtitle("Adjusted - part 1")
adjusted_1

adjusted_2 <- plot_peptides(LFQ, adjusted_all[26:49], scales = "free_y") + ggtitle("Adjusted - part 2")
adjusted_2

rest_all <- setdiff(unique(results_msqrob$protein), adjusted_all)
rest_1 <- plot_peptides(LFQ, rest_all[1:25], scales = "free_y") + ggtitle("Unadjusted - part 1")

rest_2 <- plot_peptides(LFQ, rest_all[26:37], scales = "free_y") + ggtitle("Unadjusted - part 2")

ggsave(paste0(data_folder, "/adjusted_1.png"), adjusted_1, width = save_width, height = save_height)
ggsave(paste0(data_folder, "/adjusted_2.png"), adjusted_2, width = save_width, height = save_height)
ggsave(paste0(data_folder, "/rest_1.png"), rest_1, width = save_width, height = save_height)
ggsave(paste0(data_folder, "/rest_2.png"), rest_2, width = save_width, height = save_height)
```
